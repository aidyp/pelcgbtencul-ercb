...
def xtime(byte):
	# Using bytearrays instead of byte for consistency, just take the first element #
	b = byte[0]
	if (b & 0x80):
		# This case handles for wrapping around x^8 #
...
# Next on the list is the mixing columns part of AES #

class AES:
	"""
	Class object for the cipher
	Because using functions for everything is a little bit _too_ lazy!
	"""
	...
	def __init__(self, ukey):
		...
		self._key_matrices = self._expand_key(ukey)
